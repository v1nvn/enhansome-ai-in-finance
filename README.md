# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,627 | 🐛 59 | 📅 2026-04-02 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 46,737 | 🐛 275 | 🌐 Python | 📅 2026-03-29 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 11,662 | 🐛 491 | 🌐 Go | 📅 2026-04-01 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 6,548 | 🐛 61 | 🌐 Jupyter Notebook | 📅 2026-04-03 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.
* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 1,294 | 🐛 1 | 🌐 Python | 📅 2026-03-20 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 49,977 | 🐛 93 | 🌐 Python | 📅 2026-03-28 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 18,992 | 🐛 86 | 🌐 Jupyter Notebook | 📅 2026-04-03 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* [PIXIU](https://github.com/chancefocus/PIXIU) ⭐ 845 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2025-03-04 - An open-source resource providing a financial large language model, a dataset with 136K instruction samples, and a comprehensive evaluation benchmark.
...
* 🌟 [QuantResearch](https://github.com/letianzj/QuantResearch) ⭐ 2,864 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-08-26 - Quantitative analysis, strategies and backtests <https://letianzj.github.io/>
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 14,663 | 🐛 298 | 🌐 Jupyter Notebook | 📅 2026-03-24 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
...
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 2,878 | 🐛 48 | 🌐 Python | 📅 2026-03-25 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 1,922 | 🐛 19 | 🌐 Python | 📅 2026-03-30 - Python library for portfolio optimization built on top of scikit-learn.
...
* [High-Frequency-Trading-Model-with-IB](https://github.com/jamesmawm/High-Frequency-Trading-Model-with-IB) ⭐ 2,899 | 🐛 12 | 🌐 Python | 📅 2025-05-29 - A high-frequency trading model using Interactive Brokers API with pairs and mean-reversion.
...
* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 9,591 | 🐛 2 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
* [crypto-signal](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,514 | 🐛 59 | 🌐 Python | 📅 2024-07-07 - Automated crypto trading & technical analysis (TA) bot for Bittrex, Binance, GDAX, and more.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 14,720 | 🐛 708 | 🌐 Python | 📅 2024-03-13 - Crawling historical data of Chinese stocks.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 46,275 | 🐛 130 | 🌐 TypeScript | 📅 2026-04-04 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,269 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 - Portfolio and risk analytics in Python.
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 6,122 | 🐛 44 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,054 | 🐛 21 | 🌐 Python | 📅 2026-03-07 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,698 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-04-03 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
* [empyrical](https://github.com/quantopian/empyrical) ⭐ 1,477 | 🐛 37 | 🌐 Python | 📅 2024-07-26 - Common financial risk and performance metrics. Used by Zipline and pyfolio.
* [JAQS](https://github.com/quantOS-org/JAQS) ⭐ 631 | 🐛 45 | 🌐 Python | 📅 2019-04-25 - An open source quant strategies research platform.
* [CRNG](https://github.com/brotto/crng) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-04-02 - Contingency RNG, generates random numbers with real market fat tails (K=5-220) and volatility clustering. Matches 86% of real market metrics vs 14% for NumPy. Includes regime detector.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 65,288 | 🐛 73 | 🌐 Python | 📅 2026-04-04 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 21,020 | 🐛 57 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,600 | 🐛 368 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 18,226 | 🐛 269 | 🌐 C# | 📅 2026-03-30 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,278 | 🐛 26 | 🌐 Python | 📅 2026-04-03 - A extendable, replaceable Python algorithmic backtest & trading framework.
* [kungfu](https://github.com/taurusai/kungfu) ⭐ 3,838 | 🐛 11 | 🌐 C++ | 📅 2024-05-02 - Kungfu Master trading system.
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 214 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-03 - Self-hosted execution engine for algorithmic trading bots. Supports Python, TypeScript, Rust, C++, C#, Scala, and Haskell. Each bot runs in an isolated container with scheduled or streaming execution.
* [finclaw](https://github.com/NeuZhou/finclaw) ⭐ 32 | 🐛 5 | 🌐 Python | 📅 2026-04-04 - AI-native quantitative trading engine with 484 alpha factors, genetic algorithm strategy evolution, walk-forward backtesting and paper trading. Supports A-shares, crypto, and MCP server for AI agent integration.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 16,710 | 🐛 3 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,276 | 🐛 37 | 🌐 Python | 📅 2026-02-12 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 32,693 | 🐛 19 | 🌐 JavaScript | 📅 2026-04-03 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 12,844 | 🐛 142 | 🌐 TypeScript | 📅 2026-04-02 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 3,670 | 🐛 54 | 🌐 TypeScript | 📅 2026-03-27 - Highly customizable professional lightweight financial charts

### GYM Environment

* 🌟 [TradingGym](https://github.com/Yvictor/TradingGym) ⭐ 1,860 | 🐛 11 | 🌐 Python | 📅 2024-02-11 - Trading and Backtesting environment for training reinforcement learning agent.
...
* [The-Economist](https://github.com/nailperry-zd/The-Economist) ⭐ 3,803 | 🐛 20 | 📅 2023-06-23 - The Economist.
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 25,322 | 🐛 29 | 🌐 HTML | 📅 2026-04-04 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,474 | 🐛 11 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
* 🌟 [Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 3,545 | 🐛 5 | 📅 2025-05-21 - Quant / Algorithm trading resources with an emphasis on Machine Learning.
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 2,855 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-03-11 - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
