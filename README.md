# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 462,610 | 🐛 71 | 📅 2026-05-03 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 67,886 | 🐛 358 | 🌐 Python | 📅 2026-05-01 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 12,334 | 🐛 501 | 🌐 Go | 📅 2026-04-26 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 6,862 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-04-03 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.
* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 1,600 | 🐛 1 | 🌐 Python | 📅 2026-03-20 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* [AgentFund](https://github.com/RioBot-Grind/agentfund) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-02 - Decentralized crowdfunding platform for AI agents with milestone-based escrow on Base blockchain.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 58,079 | 🐛 124 | 🌐 Python | 📅 2026-05-04 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 19,937 | 🐛 84 | 🌐 Jupyter Notebook | 📅 2026-04-24 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* 🌟🌟 [MarS](https://github.com/microsoft/MarS) ⭐ 1,700 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - A Financial Market Simulation Engine Powered by Generative Foundation Model.
* [PIXIU](https://github.com/chancefocus/PIXIU) ⭐ 854 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-03-04 - An open-source resource providing a financial large language model, a dataset with 136K instruction samples, and a comprehensive evaluation benchmark.
...
* [XVARY Stock Research](https://github.com/xvary-research/claude-code-stock-analysis-skill) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-03-23 — Claude Code skill for public SEC EDGAR + market data: `/analyze`, `/score`, `/compare`. MIT.
...
* 🌟 [QuantResearch](https://github.com/letianzj/QuantResearch) ⭐ 2,908 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-08-26 - Quantitative analysis, strategies and backtests <https://letianzj.github.io/>
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 15,062 | 🐛 302 | 🌐 Jupyter Notebook | 📅 2026-04-05 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
...
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 3,114 | 🐛 52 | 🌐 Python | 📅 2026-05-02 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [mlforecast](https://github.com/Nixtla/mlforecast) ⭐ 1,218 | 🐛 17 | 🌐 Python | 📅 2026-05-04 - Scalable machine learning based time series forecasting.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 1,956 | 🐛 19 | 🌐 Python | 📅 2026-05-04 - Python library for portfolio optimization built on top of scikit-learn.
...
* [DeepDow](https://github.com/jankrepl/deepdow) ⭐ 1,134 | 🐛 27 | 🌐 Python | 📅 2024-01-24 - Portfolio optimization with deep learning.
...
* [High-Frequency-Trading-Model-with-IB](https://github.com/jamesmawm/High-Frequency-Trading-Model-with-IB) ⭐ 2,877 | 🐛 12 | 🌐 Python | 📅 2025-05-29 - A high-frequency trading model using Interactive Brokers API with pairs and mean-reversion.
* 🌟 [SGX-Full-OrderBook-Tick-Data-Trading-Strategy](https://github.com/rorysroes/SGX-Full-OrderBook-Tick-Data-Trading-Strategy) ⭐ 2,268 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2022-08-27 - Solutions for high-frequency trading (HFT) strategies using data science approaches (Machine Learning) on Full Orderbook Tick Data.
...
* [gekko-neuralnet](https://github.com/zschro/gekko-neuralnet) ⭐ 93 | 🐛 0 | 🌐 JavaScript | 📅 2020-07-16 - Neural network strategy for Gekko.
...
* [DeepAlpha](https://github.com/stefanoviana/deepalpha) ⭐ 8 | 🐛 17 | 🌐 Python | 📅 2026-05-04 - AI-powered crypto trading bot with 3-model ML ensemble (XGBoost, LightGBM, CatBoost), 12 exchanges via CCXT, walk-forward validated.

### Technical Analysis

* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 9,776 | 🐛 3 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
* [crypto-signal](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,542 | 🐛 59 | 🌐 Python | 📅 2024-07-07 - Automated crypto trading & technical analysis (TA) bot for Bittrex, Binance, GDAX, and more.
...
* [QTradeX](https://github.com/squidKid-deluxe/QTradeX-Algo-Trading-SDK) ⭐ 66 | 🐛 5 | 🌐 Python | 📅 2026-01-13 - A powerful and flexible Python framework for designing, backtesting, optimizing, and deploying algotrading bots
...
* [bitcoin-arbitrage](https://github.com/maxme/bitcoin-arbitrage) ⭐ 2,575 | 🐛 14 | 🌐 Python | 📅 2024-10-20 - Bitcoin arbitrage opportunity detector.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 14,836 | 🐛 713 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
* [yahoo-finance](https://github.com/lukaszbanasiak/yahoo-finance) ⭐ 1,430 | 🐛 88 | 🌐 Python | 📅 2023-12-25 - Python module to get stock data from Yahoo! Finance.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 53,462 | 🐛 160 | 🌐 TypeScript | 📅 2026-05-04 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,300 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 - Portfolio and risk analytics in Python.
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 6,224 | 🐛 45 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
* [alphalens](https://github.com/quantopian/alphalens) ⭐ 4,252 | 🐛 49 | 🌐 Jupyter Notebook | 📅 2024-02-12 - Performance analysis of predictive (alpha) stock factors.
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,123 | 🐛 21 | 🌐 Python | 📅 2026-04-13 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,733 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-05-04 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 67,022 | 🐛 78 | 🌐 Python | 📅 2026-05-04 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 21,390 | 🐛 59 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,723 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 18,787 | 🐛 256 | 🌐 C# | 📅 2026-05-04 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,345 | 🐛 28 | 🌐 Python | 📅 2026-04-30 - A extendable, replaceable Python algorithmic backtest & trading framework.
* [kungfu](https://github.com/taurusai/kungfu) ⭐ 3,859 | 🐛 11 | 🌐 C++ | 📅 2024-05-02 - Kungfu Master trading system.
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 229 | 🐛 19 | 🌐 TypeScript | 📅 2026-04-23 - Self-hosted execution engine for algorithmic trading bots. Supports Python, TypeScript, Rust, C++, C#, Scala, and Haskell. Each bot runs in an isolated container with scheduled or streaming execution.
* [finclaw](https://github.com/NeuZhou/finclaw) ⭐ 12 | 🐛 0 | 📅 2026-04-18 - AI-native quantitative trading engine with 484 alpha factors, genetic algorithm strategy evolution, walk-forward backtesting and paper trading. Supports A-shares, crypto, and MCP server for AI agent integration.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 17,015 | 🐛 4 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [ctpwrapper](https://github.com/nooperpudd/ctpwrapper) ⭐ 573 | 🐛 19 | 🌐 Python | 📅 2025-05-03 - Shanghai future exchange CTP api.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,333 | 🐛 38 | 🌐 Python | 📅 2026-02-12 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 32,835 | 🐛 19 | 🌐 JavaScript | 📅 2026-05-04 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 12,893 | 🐛 146 | 🌐 TypeScript | 📅 2026-04-08 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 3,744 | 🐛 56 | 🌐 TypeScript | 📅 2026-04-28 - Highly customizable professional lightweight financial charts

### GYM Environment

* 🌟 [TradingGym](https://github.com/Yvictor/TradingGym) ⭐ 1,870 | 🐛 11 | 🌐 Python | 📅 2024-02-11 - Trading and Backtesting environment for training reinforcement learning agent.
...
* [The-Economist](https://github.com/nailperry-zd/The-Economist) ⭐ 3,820 | 🐛 20 | 📅 2023-06-23 - The Economist.
...
* [Registry Broker](https://github.com/hashgraph-online/hashnet-mcp-js) ⭐ 12 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-13 - Universal AI agent index for discovering trading agents across Virtuals Protocol, NANDA, MCP, and other registries.
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 25,997 | 🐛 29 | 🌐 HTML | 📅 2026-05-05 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,540 | 🐛 14 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
* 🌟 [Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 3,627 | 🐛 17 | 📅 2025-05-21 - Quant / Algorithm trading resources with an emphasis on Machine Learning.
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 2,917 | 🐛 49 | 🌐 Jupyter Notebook | 📅 2026-04-25 - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
