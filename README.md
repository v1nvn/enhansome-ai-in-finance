# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,876 | 🐛 68 | 📅 2026-01-28 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 29,464 | 🐛 229 | 🌐 Python | 📅 2026-02-07 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 10,414 | 🐛 470 | 🌐 Go | 📅 2026-02-06 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 6,070 | 🐛 62 | 🌐 Jupyter Notebook | 📅 2026-01-30 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.

## LLMs

* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 45,653 | 🐛 51 | 🌐 Python | 📅 2026-02-02 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 18,566 | 🐛 83 | 🌐 Jupyter Notebook | 📅 2026-02-06 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* 🌟🌟 [MarS](https://github.com/microsoft/MarS) ⭐ 1,647 | 🐛 10 | 🌐 Python | 📅 2025-08-06 - A Financial Market Simulation Engine Powered by Generative Foundation Model.
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 13,902 | 🐛 294 | 🌐 Jupyter Notebook | 📅 2026-01-30 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 1,863 | 🐛 23 | 🌐 Python | 📅 2026-01-29 - Python library for portfolio optimization built on top of scikit-learn.
...
* [High-Frequency-Trading-Model-with-IB](https://github.com/jamesmawm/High-Frequency-Trading-Model-with-IB) ⭐ 2,884 | 🐛 12 | 🌐 Python | 📅 2025-05-29 - A high-frequency trading model using Interactive Brokers API with pairs and mean-reversion.
...
* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 9,112 | 🐛 3 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
* [crypto-signal](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,459 | 🐛 57 | 🌐 Python | 📅 2024-07-07 - Automated crypto trading & technical analysis (TA) bot for Bittrex, Binance, GDAX, and more.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 14,412 | 🐛 688 | 🌐 Python | 📅 2024-03-13 - Crawling historical data of Chinese stocks.
...
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 5,904 | 🐛 41 | 🌐 Python | 📅 2026-02-08 - Trade efficiently with reinforcement learning.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 3,950 | 🐛 18 | 🌐 Python | 📅 2026-01-18 - Zero vector trader.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 59,944 | 🐛 51 | 🌐 Python | 📅 2026-02-07 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 20,359 | 🐛 56 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,390 | 🐛 367 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 16,313 | 🐛 246 | 🌐 C# | 📅 2026-02-06 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,142 | 🐛 30 | 🌐 Python | 📅 2026-02-05 - A extendable, replaceable Python algorithmic backtest & trading framework.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 16,138 | 🐛 3 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [ctpwrapper](https://github.com/nooperpudd/ctpwrapper) ⭐ 559 | 🐛 19 | 🌐 Python | 📅 2025-05-03 - Shanghai future exchange CTP api.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,214 | 🐛 37 | 🌐 Python | 📅 2025-03-21 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 32,358 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-08 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 12,769 | 🐛 139 | 🌐 TypeScript | 📅 2026-01-21 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 3,554 | 🐛 51 | 🌐 TypeScript | 📅 2026-01-09 - Highly customizable professional lightweight financial charts
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 24,107 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2026-02-08 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,383 | 🐛 9 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
