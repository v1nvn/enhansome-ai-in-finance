# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 455,369 | 🐛 62 | 📅 2026-04-02 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 50,512 | 🐛 256 | 🌐 Python | 📅 2026-04-13 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 11,924 | 🐛 499 | 🌐 Go | 📅 2026-04-14 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 6,694 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-04-03 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.
* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 1,342 | 🐛 1 | 🌐 Python | 📅 2026-03-20 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 54,349 | 🐛 106 | 🌐 Python | 📅 2026-04-15 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 19,404 | 🐛 86 | 🌐 Jupyter Notebook | 📅 2026-04-10 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* 🌟🌟 [MarS](https://github.com/microsoft/MarS) ⭐ 1,689 | 🐛 13 | 🌐 Python | 📅 2026-04-08 - A Financial Market Simulation Engine Powered by Generative Foundation Model.
* [PIXIU](https://github.com/chancefocus/PIXIU) ⭐ 849 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-03-04 - An open-source resource providing a financial large language model, a dataset with 136K instruction samples, and a comprehensive evaluation benchmark.
...
* 🌟 [QuantResearch](https://github.com/letianzj/QuantResearch) ⭐ 2,877 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-08-26 - Quantitative analysis, strategies and backtests <https://letianzj.github.io/>
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 14,754 | 🐛 301 | 🌐 Jupyter Notebook | 📅 2026-04-05 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
* 🌟🌟 [stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,549 | 🐛 365 | 🌐 JavaScript | 📅 2025-08-19 - A complete process for predicting stock price movements.
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 2,945 | 🐛 48 | 🌐 Python | 📅 2026-04-14 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 1,929 | 🐛 20 | 🌐 Python | 📅 2026-04-14 - Python library for portfolio optimization built on top of scikit-learn.
...
* [DeepDow](https://github.com/jankrepl/deepdow) ⭐ 1,127 | 🐛 27 | 🌐 Python | 📅 2024-01-24 - Portfolio optimization with deep learning.
...
* 🌟🌟 [stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,549 | 🐛 365 | 🌐 JavaScript | 📅 2025-08-19 - Complete process for predicting stock price movements.
...
* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 9,664 | 🐛 2 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 14,757 | 🐛 710 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 48,327 | 🐛 102 | 🌐 TypeScript | 📅 2026-04-15 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,283 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 - Portfolio and risk analytics in Python.
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 6,160 | 🐛 44 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,089 | 🐛 21 | 🌐 Python | 📅 2026-04-13 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,707 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-04-14 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 65,895 | 🐛 76 | 🌐 Python | 📅 2026-04-14 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 21,141 | 🐛 57 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,629 | 🐛 369 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 18,409 | 🐛 248 | 🌐 C# | 📅 2026-04-14 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,294 | 🐛 27 | 🌐 Python | 📅 2026-04-15 - A extendable, replaceable Python algorithmic backtest & trading framework.
* [kungfu](https://github.com/taurusai/kungfu) ⭐ 3,843 | 🐛 11 | 🌐 C++ | 📅 2024-05-02 - Kungfu Master trading system.
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 217 | 🐛 18 | 🌐 TypeScript | 📅 2026-04-14 - Self-hosted execution engine for algorithmic trading bots. Supports Python, TypeScript, Rust, C++, C#, Scala, and Haskell. Each bot runs in an isolated container with scheduled or streaming execution.
* [finclaw](https://github.com/NeuZhou/finclaw) ⭐ 48 | 🐛 13 | 🌐 Python | 📅 2026-04-14 - AI-native quantitative trading engine with 484 alpha factors, genetic algorithm strategy evolution, walk-forward backtesting and paper trading. Supports A-shares, crypto, and MCP server for AI agent integration.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 16,847 | 🐛 4 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,301 | 🐛 38 | 🌐 Python | 📅 2026-02-12 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 32,754 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-14 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 12,864 | 🐛 145 | 🌐 TypeScript | 📅 2026-04-08 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 3,688 | 🐛 55 | 🌐 TypeScript | 📅 2026-04-05 - Highly customizable professional lightweight financial charts
...
* [The-Economist](https://github.com/nailperry-zd/The-Economist) ⭐ 3,812 | 🐛 20 | 📅 2023-06-23 - The Economist.
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 25,532 | 🐛 32 | 🌐 HTML | 📅 2026-04-15 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,504 | 🐛 10 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
* 🌟 [Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 3,566 | 🐛 10 | 📅 2025-05-21 - Quant / Algorithm trading resources with an emphasis on Machine Learning.
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 2,879 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-04-14 - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
