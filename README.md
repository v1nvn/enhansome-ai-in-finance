# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 462,163 | 🐛 73 | 📅 2026-05-03 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 65,664 | 🐛 340 | 🌐 Python | 📅 2026-05-01 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 12,328 | 🐛 501 | 🌐 Go | 📅 2026-04-26 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 6,854 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-04-03 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.
* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 1,551 | 🐛 1 | 🌐 Python | 📅 2026-03-20 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 57,995 | 🐛 121 | 🌐 Python | 📅 2026-05-03 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 19,930 | 🐛 84 | 🌐 Jupyter Notebook | 📅 2026-04-24 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* 🌟🌟 [MarS](https://github.com/microsoft/MarS) ⭐ 1,699 | 🐛 14 | 🌐 Python | 📅 2026-04-21 - A Financial Market Simulation Engine Powered by Generative Foundation Model.
...
* 🌟 [QuantResearch](https://github.com/letianzj/QuantResearch) ⭐ 2,906 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-08-26 - Quantitative analysis, strategies and backtests <https://letianzj.github.io/>
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 15,049 | 🐛 302 | 🌐 Jupyter Notebook | 📅 2026-04-05 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
...
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 3,104 | 🐛 52 | 🌐 Python | 📅 2026-05-02 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 1,956 | 🐛 19 | 🌐 Python | 📅 2026-05-01 - Python library for portfolio optimization built on top of scikit-learn.
...
* [DeepAlpha](https://github.com/stefanoviana/deepalpha) ⭐ 8 | 🐛 12 | 🌐 Python | 📅 2026-05-03 - AI-powered crypto trading bot with 3-model ML ensemble (XGBoost, LightGBM, CatBoost), 12 exchanges via CCXT, walk-forward validated.

### Technical Analysis

* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 9,775 | 🐛 3 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
* [crypto-signal](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,543 | 🐛 59 | 🌐 Python | 📅 2024-07-07 - Automated crypto trading & technical analysis (TA) bot for Bittrex, Binance, GDAX, and more.
...
* [QTradeX](https://github.com/squidKid-deluxe/QTradeX-Algo-Trading-SDK) ⭐ 65 | 🐛 5 | 🌐 Python | 📅 2026-01-13 - A powerful and flexible Python framework for designing, backtesting, optimizing, and deploying algotrading bots
...
* [bitcoin-arbitrage](https://github.com/maxme/bitcoin-arbitrage) ⭐ 2,574 | 🐛 14 | 🌐 Python | 📅 2024-10-20 - Bitcoin arbitrage opportunity detector.
* [cryptocurrency-arbitrage](https://github.com/manu354/cryptocurrency-arbitrage) ⭐ 1,272 | 🐛 17 | 🌐 JavaScript | 📅 2022-05-15 - A crypto currency arbitrage opportunity calculator. Over 800 currencies and 50 markets.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 14,833 | 🐛 713 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 53,358 | 🐛 161 | 🌐 TypeScript | 📅 2026-05-03 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 6,221 | 🐛 45 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,120 | 🐛 21 | 🌐 Python | 📅 2026-04-13 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,731 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-05-03 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 66,944 | 🐛 78 | 🌐 Python | 📅 2026-05-03 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 21,356 | 🐛 59 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,721 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 18,748 | 🐛 265 | 🌐 C# | 📅 2026-05-01 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,343 | 🐛 28 | 🌐 Python | 📅 2026-04-30 - A extendable, replaceable Python algorithmic backtest & trading framework.
* [kungfu](https://github.com/taurusai/kungfu) ⭐ 3,858 | 🐛 11 | 🌐 C++ | 📅 2024-05-02 - Kungfu Master trading system.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 17,011 | 🐛 4 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,332 | 🐛 38 | 🌐 Python | 📅 2026-02-12 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 32,833 | 🐛 19 | 🌐 JavaScript | 📅 2026-05-03 - Visualizer for deep learning and machine learning models.
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 25,983 | 🐛 28 | 🌐 HTML | 📅 2026-05-04 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,538 | 🐛 13 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
* 🌟 [Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 3,625 | 🐛 16 | 📅 2025-05-21 - Quant / Algorithm trading resources with an emphasis on Machine Learning.
