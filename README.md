# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,670 | 🐛 62 | 📅 2026-04-02 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 49,935 | 🐛 267 | 🌐 Python | 📅 2026-04-04 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 11,857 | 🐛 494 | 🌐 Go | 📅 2026-04-12 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 6,667 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-04-03 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.
* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 1,334 | 🐛 1 | 🌐 Python | 📅 2026-03-20 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 52,307 | 🐛 99 | 🌐 Python | 📅 2026-04-09 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 19,058 | 🐛 86 | 🌐 Jupyter Notebook | 📅 2026-04-10 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 14,730 | 🐛 301 | 🌐 Jupyter Notebook | 📅 2026-04-05 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
* 🌟🌟 [stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,544 | 🐛 365 | 🌐 JavaScript | 📅 2025-08-19 - A complete process for predicting stock price movements.
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 2,930 | 🐛 49 | 🌐 Python | 📅 2026-03-25 - Deep Reinforcement Learning for Automated Stock Trading.
...
* 🌟 [SGX-Full-OrderBook-Tick-Data-Trading-Strategy](https://github.com/rorysroes/SGX-Full-OrderBook-Tick-Data-Trading-Strategy) ⭐ 2,254 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2022-08-27 - Solutions for high-frequency trading (HFT) strategies using data science approaches (Machine Learning) on Full Orderbook Tick Data.
...
* 🌟🌟 [stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,544 | 🐛 365 | 🌐 JavaScript | 📅 2025-08-19 - Complete process for predicting stock price movements.
...
* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 9,650 | 🐛 2 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 14,744 | 🐛 710 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 48,018 | 🐛 98 | 🌐 TypeScript | 📅 2026-04-13 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 6,135 | 🐛 44 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,083 | 🐛 20 | 🌐 Python | 📅 2026-03-07 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,705 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-04-12 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 65,784 | 🐛 76 | 🌐 Python | 📅 2026-04-11 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 21,111 | 🐛 57 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,625 | 🐛 369 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 18,376 | 🐛 261 | 🌐 C# | 📅 2026-04-10 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,292 | 🐛 28 | 🌐 Python | 📅 2026-04-09 - A extendable, replaceable Python algorithmic backtest & trading framework.
* [kungfu](https://github.com/taurusai/kungfu) ⭐ 3,843 | 🐛 11 | 🌐 C++ | 📅 2024-05-02 - Kungfu Master trading system.
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 217 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-12 - Self-hosted execution engine for algorithmic trading bots. Supports Python, TypeScript, Rust, C++, C#, Scala, and Haskell. Each bot runs in an isolated container with scheduled or streaming execution.
* [finclaw](https://github.com/NeuZhou/finclaw) ⭐ 47 | 🐛 22 | 🌐 Python | 📅 2026-04-13 - AI-native quantitative trading engine with 484 alpha factors, genetic algorithm strategy evolution, walk-forward backtesting and paper trading. Supports A-shares, crypto, and MCP server for AI agent integration.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 16,817 | 🐛 4 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,296 | 🐛 38 | 🌐 Python | 📅 2026-02-12 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 32,735 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-13 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 12,861 | 🐛 145 | 🌐 TypeScript | 📅 2026-04-08 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 3,686 | 🐛 55 | 🌐 TypeScript | 📅 2026-04-05 - Highly customizable professional lightweight financial charts
...
* [The-Economist](https://github.com/nailperry-zd/The-Economist) ⭐ 3,808 | 🐛 20 | 📅 2023-06-23 - The Economist.
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 25,460 | 🐛 23 | 🌐 HTML | 📅 2026-04-13 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,494 | 🐛 10 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
* 🌟 [Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 3,564 | 🐛 8 | 📅 2025-05-21 - Quant / Algorithm trading resources with an emphasis on Machine Learning.
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 2,876 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-03-11 - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
