# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 475,862 | 🐛 81 | 📅 2026-06-02 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 86,269 | 🐛 294 | 🌐 Python | 📅 2026-06-14 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 12,472 | 🐛 509 | 🌐 Go | 📅 2026-06-11 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 12,210 | 🐛 6 | 🌐 Python | 📅 2026-06-14 - Multi-agent finance research workspace for strategy generation, backtests, portfolio analysis, and research insights.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 7,267 | 🐛 71 | 🌐 Jupyter Notebook | 📅 2026-05-10 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.
* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 1,954 | 🐛 2 | 🌐 Python | 📅 2026-05-27 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 60,091 | 🐛 142 | 🌐 Python | 📅 2026-06-14 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 20,497 | 🐛 94 | 🌐 Jupyter Notebook | 📅 2026-06-01 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* [PIXIU](https://github.com/chancefocus/PIXIU) ⭐ 868 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-03-04 - An open-source resource providing a financial large language model, a dataset with 136K instruction samples, and a comprehensive evaluation benchmark.
...
* 🌟 [QuantResearch](https://github.com/letianzj/QuantResearch) ⭐ 2,949 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-08-26 - Quantitative analysis, strategies and backtests <https://letianzj.github.io/>
...
* [FinRL](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 15,420 | 🐛 301 | 🌐 Jupyter Notebook | 📅 2026-05-25 - A Deep Reinforcement Learning Library for Automated Stock Trading in Quantitative Finance.
* 🌟🌟 [stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,577 | 🐛 365 | 🌐 JavaScript | 📅 2025-08-19 - A complete process for predicting stock price movements.
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 3,311 | 🐛 52 | 🌐 Python | 📅 2026-05-02 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [DeepDow](https://github.com/jankrepl/deepdow) ⭐ 1,148 | 🐛 27 | 🌐 Python | 📅 2024-01-24 - Portfolio optimization with deep learning.
...
* 🌟🌟 [stockpredictionai](https://github.com/borisbanushev/stockpredictionai) ⭐ 5,577 | 🐛 365 | 🌐 JavaScript | 📅 2025-08-19 - Complete process for predicting stock price movements.
...
* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 10,086 | 🐛 5 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
* [crypto-signal](https://github.com/CryptoSignal/crypto-signal) ⭐ 5,578 | 🐛 60 | 🌐 Python | 📅 2024-07-07 - Automated crypto trading & technical analysis (TA) bot for Bittrex, Binance, GDAX, and more.
* [Gekko-Strategies](https://github.com/xFFFFF/Gekko-Strategies) ⭐ 1,425 | 🐛 19 | 🌐 JavaScript | 📅 2020-01-09 - Strategies to Gekko trading bot with backtests results and some useful tools.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 15,142 | 🐛 736 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 56,469 | 🐛 166 | 🌐 TypeScript | 📅 2026-06-14 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* 🌟🌟 [TensorTrade](https://github.com/tensortrade-org/tensortrade) ⭐ 6,340 | 🐛 45 | 🌐 Python | 📅 2026-02-19 - Trade efficiently with reinforcement learning.
* [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,331 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 - Portfolio and risk analytics in Python.
* [alphalens](https://github.com/quantopian/alphalens) ⭐ 4,324 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2024-02-12 - Performance analysis of predictive (alpha) stock factors.
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,174 | 🐛 21 | 🌐 Python | 📅 2026-04-13 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,755 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-06-14 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 69,162 | 🐛 70 | 🌐 Python | 📅 2026-06-15 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 21,982 | 🐛 62 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 19,879 | 🐛 246 | 🌐 C# | 📅 2026-06-12 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,874 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,478 | 🐛 28 | 🌐 Python | 📅 2026-06-15 - A extendable, replaceable Python algorithmic backtest & trading framework.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 17,471 | 🐛 5 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [ctpwrapper](https://github.com/nooperpudd/ctpwrapper) ⭐ 584 | 🐛 18 | 🌐 Python | 📅 2026-06-08 - Shanghai future exchange CTP api.
...
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,402 | 🐛 39 | 🌐 Python | 📅 2026-02-12 - High-performance TensorFlow library for quantitative finance.

### Visualizing

* [netron](https://github.com/lutzroeder/netron) ⭐ 33,080 | 🐛 18 | 🌐 JavaScript | 📅 2026-06-14 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 12,936 | 🐛 147 | 🌐 TypeScript | 📅 2026-06-10 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 3,863 | 🐛 31 | 🌐 TypeScript | 📅 2026-06-13 - Highly customizable professional lightweight financial charts

### GYM Environment

* 🌟 [TradingGym](https://github.com/Yvictor/TradingGym) ⭐ 1,885 | 🐛 11 | 🌐 Python | 📅 2024-02-11 - Trading and Backtesting environment for training reinforcement learning agent.
...
* [The-Economist](https://github.com/nailperry-zd/The-Economist) ⭐ 3,857 | 🐛 20 | 📅 2023-06-23 - The Economist.
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 26,780 | 🐛 41 | 🌐 HTML | 📅 2026-06-15 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,646 | 🐛 14 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
* 🌟 [Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 3,692 | 🐛 17 | 📅 2025-05-21 - Quant / Algorithm trading resources with an emphasis on Machine Learning.
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 3,001 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-05-26 - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
