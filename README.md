# Awesome AI in Finance [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,982 | 🐛 59 | 📅 2026-04-02 [![Community](https://img.shields.io/discord/733027681184251937.svg?style=flat\&label=Join%20Community\&color=7289DA)](https://discord.gg/cqaUf47) with stars
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 49,329 | 🐛 262 | 🌐 Python | 📅 2026-04-04 - Multi-Agents LLM Financial Trading Framework.
* 🌟🌟 [nofx](https://github.com/NoFxAiOS/nofx) ⭐ 11,778 | 🐛 491 | 🌐 Go | 📅 2026-04-10 - A multi-exchange Al trading platform with multi-Ai competition self-evolution, and real-time dashboard.
* 🌟 [FinRobot](https://github.com/AI4Finance-Foundation/FinRobot) ⭐ 6,647 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-04-03 - An Open-Source AI Agent Platform for Financial Analysis using LLMs.
* 🌟 [ATLAS](https://github.com/chrisworsey55/atlas-gic) ⭐ 1,325 | 🐛 1 | 🌐 Python | 📅 2026-03-20 - Self-improving AI trading system with 25 agents, Karpathy-style autoresearch, Darwinian selection, autonomous agent spawning, and multi-cohort meta-weighting.
...
* 🌟 [AI Hedge Fund](https://github.com/virattt/ai-hedge-fund) ⭐ 51,000 | 🐛 96 | 🌐 Python | 📅 2026-04-09 - Explore the use of AI to make trading decisions.
* [FinGPT](https://github.com/AI4Finance-Foundation/FinGPT) ⭐ 19,046 | 🐛 86 | 🌐 Jupyter Notebook | 📅 2026-04-10 - Provides a playground for all people interested in LLMs and NLP in Finance.
...
* 🌟🌟 [MarS](https://github.com/microsoft/MarS) ⭐ 1,684 | 🐛 13 | 🌐 Python | 📅 2026-04-08 - A Financial Market Simulation Engine Powered by Generative Foundation Model.
...
* 🌟 [QuantResearch](https://github.com/letianzj/QuantResearch) ⭐ 2,871 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-08-26 - Quantitative analysis, strategies and backtests <https://letianzj.github.io/>
...
* 🌟 [Ensemble-Strategy](https://github.com/AI4Finance-LLC/Deep-Reinforcement-Learning-for-Automated-Stock-Trading-Ensemble-Strategy-ICAIF-2020) ⭐ 2,922 | 🐛 48 | 🌐 Python | 📅 2026-03-25 - Deep Reinforcement Learning for Automated Stock Trading.
...
* [quant-trading](https://github.com/je-suis-tm/quant-trading) ⭐ 9,637 | 🐛 2 | 🌐 Python | 📅 2024-04-14 - Python quantitative trading strategies.
...
* [Tushare](https://github.com/waditu/tushare) ⭐ 14,739 | 🐛 710 | 🌐 Python | 📅 2024-03-13 - TuShare is a utility for crawling historical data of China stocks.
...
* [WorldMonitor](https://github.com/koala73/worldmonitor) ⭐ 47,728 | 🐛 101 | 🌐 TypeScript | 📅 2026-04-11 - AI-powered news aggregation, geopolitical monitoring, and infrastructure tracking in a unified situational awareness interface.
...
* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,063 | 🐛 20 | 🌐 Python | 📅 2026-03-07 - Zero vector trader.
* [WFGY](https://github.com/onestardao/WFGY) ⭐ 1,702 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-04-10 – Open source framework for debugging and stress testing LLM agents and RAG pipelines. Includes a 16 mode failure map and long-horizon stress tests that are useful for financial research agents.
...
* 🌟🌟🌟 [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 65,678 | 🐛 76 | 🌐 Python | 📅 2026-04-11 - AI-powered opensource research and analytics workspace.
* [backtrader](https://github.com/backtrader/backtrader) ⭐ 21,086 | 🐛 57 | 🌐 Python | 📅 2024-08-19 - Python backtesting library for trading strategies.
* 🌟🌟 [zipline](https://github.com/quantopian/zipline) ⭐ 19,617 | 🐛 368 | 🌐 Python | 📅 2024-02-13 - A python algorithmic trading library.
* [lean](https://github.com/QuantConnect/Lean) ⭐ 18,329 | 🐛 256 | 🌐 C# | 📅 2026-04-10 - Algorithmic trading engine built for easy strategy research, backtesting and live trading.
...
* [finclaw](https://github.com/NeuZhou/finclaw) ⭐ 44 | 🐛 4 | 🌐 Python | 📅 2026-04-11 - AI-native quantitative trading engine with 484 alpha factors, genetic algorithm strategy evolution, walk-forward backtesting and paper trading. Supports A-shares, crypto, and MCP server for AI agent integration.
...
* [abu](https://github.com/bbfamily/abu) ⭐ 16,794 | 🐛 4 | 🌐 Python | 📅 2026-01-24 - A quant trading system base on python.
...
* [netron](https://github.com/lutzroeder/netron) ⭐ 32,726 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-10 - Visualizer for deep learning and machine learning models.
* [playground](https://github.com/tensorflow/playground) ⭐ 12,857 | 🐛 145 | 🌐 TypeScript | 📅 2026-04-08 - Play with neural networks.
* [KLineChart](https://github.com/liihuu/KLineChart) ⭐ 3,683 | 🐛 54 | 🌐 TypeScript | 📅 2026-04-05 - Highly customizable professional lightweight financial charts
...
* [awesome-quant](https://github.com/wilsonfreitas/awesome-quant) ⭐ 25,426 | 🐛 24 | 🌐 HTML | 📅 2026-04-11 - A curated list of insanely awesome libraries, packages and resources for Quants (Quantitative Finance).
...
* 🌟🌟 [Financial Machine Learning](https://github.com/firmai/financial-machine-learning) ⭐ 8,489 | 🐛 11 | 🌐 Python | 📅 2025-01-03 - A curated list of practical financial machine learning (FinML) tools and applications. This collection is primarily in Python.
* 🌟 [Awesome-Quant-Machine-Learning-Trading](https://github.com/grananqvist/Awesome-Quant-Machine-Learning-Trading) ⭐ 3,561 | 🐛 8 | 📅 2025-05-21 - Quant / Algorithm trading resources with an emphasis on Machine Learning.
